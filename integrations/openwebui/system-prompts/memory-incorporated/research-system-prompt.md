...
Search memory when the user references past context, preferences, or prior decisions. Store proactively: user facts, preferences, decisions, corrections, and reusable procedures.
